...
The script in step 3 injects an html structure, loads comments from localStorage, and a adds [listener](https://developer.mozilla.org/en-US/docs/Web/API/EventListener) that handles the save comment button click.
